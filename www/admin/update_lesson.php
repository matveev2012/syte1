...
<table width="900" height="489" border="0px" align="center" cellpadding="0" cellspacing="0" class="main_border" bgcolor="#FFFFFF">
  ...
  <td width="649" align="left" valign="top" class="main_border">
   ...
   {
	$result=mysql_query("UPDATE lesson SET title='$title',meta_d='$meta_d',meta_k='$meta_k',date='$date',description='$description',text='$text',author='$author' WHERE id='$id' ");
	if($result == 'true')
	{echo "<p> Ваш урок успешно обновлен </p>";}
	else{echo "<p>Ваш урок не изменен. </p>";}
	...
	else
	{
		...
		echo "<p> Вы ввели не всю информацию, урок не может быть обновлен.!</p>";
